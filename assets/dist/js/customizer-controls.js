...
var ResponsiveControl = /*#__PURE__*/function (_Component) {
  function ResponsiveControl(props) {
    ...
    _this = _callSuper(this, ResponsiveControl, [props]);
    _this.state = {
      view: 'desktop'
    };
  ...
  return _createClass(ResponsiveControl, [{
    key: "render",
...
var FontFamilyComponent = /*#__PURE__*/function (_Component) {
  function FontFamilyComponent(props) {
    ...
    _this = _callSuper(this, FontFamilyComponent, [props]);
  ...
  return _createClass(FontFamilyComponent, [{
...
var FontFamilySelector = /*#__PURE__*/function (_Component) {
  function FontFamilySelector(props) {
    ...
    _this = _callSuper(this, FontFamilySelector, [props]);
  ...
  return _createClass(FontFamilySelector, [{
    key: "getFonts",
...
var FontPreviewLink = /*#__PURE__*/function (_Component) {
  function FontPreviewLink(props) {
    ...
    _this = _callSuper(this, FontPreviewLink, [props]);
    _this.state = {
  ...
  return _createClass(FontPreviewLink, [{
    key: "render",
    value: function render() {
      var _this2 = this;
      var style = {
...
var TypographyComponent = /*#__PURE__*/function (_Component) {
  function TypographyComponent(props) {
    ...
    _this = _callSuper(this, TypographyComponent, [props]);
    var value = props.control.setting.get();
    var defaultParams = {
      weight_default: 400,
      text_transform: 'none',
    ...
    _this.renderFontSize = _this.renderFontSize.bind(_this);
    _this.renderFontWeight = _this.renderFontWeight.bind(_this);
    _this.controlHeader = _this.controlHeader.bind(_this);
    _this.unitButtons = _this.unitButtons.bind(_this);
    _this.renderTextTransform = _this.renderTextTransform.bind(_this);
    _this.updateValues = _this.updateValues.bind(_this);
    return _this;
  }
  _inherits(TypographyComponent, _Component);
  return _createClass(TypographyComponent, [{
    key: "getEmptyValue",
...
module.exports = __webpack_require__(/*! /Users/nuralam/valet/template-import/wp-content/themes/tutorstarter/inc/Api/Customizer/reactjs/src/customizer-controls.js */"./inc/Api/Customizer/reactjs/src/customizer-controls.js");
