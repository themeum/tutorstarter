...
var Header = function Header() {
  ...
  }, /*#__PURE__*/React.createElement(!(function webpackMissingModule() { var e = new Error("Cannot find module 'react-router-dom'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), {
    to: "/wp-admin/admin.php?page=tutorstarter"
  }, "General"), /*#__PURE__*/React.createElement(!(function webpackMissingModule() { var e = new Error("Cannot find module 'react-router-dom'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), {
    to: "/wp-admin/admin.php?page=tutorstarter-useful-plugins"
  }, "Useful Plugins"), /*#__PURE__*/React.createElement(!(function webpackMissingModule() { var e = new Error("Cannot find module 'react-router-dom'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), {
...
var useQuery = function useQuery() {
  return new URLSearchParams(!(function webpackMissingModule() { var e = new Error("Cannot find module 'react-router-dom'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())().search);
};
...
render( /*#__PURE__*/React.createElement(!(function webpackMissingModule() { var e = new Error("Cannot find module 'react-router-dom'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), null, /*#__PURE__*/React.createElement(_index__WEBPACK_IMPORTED_MODULE_1__["default"], null)), document.getElementById('tutorstarter-dashboard'));
