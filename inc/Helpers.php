...
if ( ! function_exists( 'tutor_starter_header_cart' ) ) {
	function tutor_starter_header_cart() { ?>
		...
		<a id="mini-cart-count" class="tutor-cart-contents" href="" title="view your shopping cart">
			<span class="count">
				<?php 
					echo wp_kses_data( 
...
if ( ! function_exists( 'tutor_starter_cart_link_fragment' ) ) {
    function tutor_starter_cart_link_fragment( $fragments ) {
		...
		<a id="mini-cart-count" class="tutor-cart-contents" data-toggle="modal" href="" title="View your shopping cart">
			<span class="count">
				<?php 
					echo wp_kses_data( 
						sprintf( _n( '%d', '%d', WC()->cart->get_cart_contents_count(), 'tutorstarter' ), 
